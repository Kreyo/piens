...
app.get('/api/users', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                return [4 /*yield*/, users_1.fetchAll()];
            case 1:
                result = _b.sent();
                res.send(result);
                return [3 /*break*/, 3];
...
app.post('/api/users', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, surname, email, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _a = req.body, name = _a.name, surname = _a.surname, email = _a.email;
            ...
            case 1:
                _c.trys.push([1, 3, , 4]);
                return [4 /*yield*/, users_1.insert({ name: name, surname: surname, email: email })];
            case 2:
                _c.sent();
                res.statusCode = 200;
                res.send();
